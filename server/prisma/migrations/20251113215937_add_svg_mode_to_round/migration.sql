...
INSERT INTO "new_rounds" ("deadlineMs", "endedAt", "id", "index", "maxTokens", "prompt", "seed", "sessionId", "startedAt", "temperature") SELECT "deadlineMs", "endedAt", "id", "index", "maxTokens", "prompt", "seed", "sessionId", "startedAt", "temperature" FROM "rounds";
DROP TABLE "rounds";
